<template>
    ...
    <el-select v-model="group" class="form select" placeholder="Select" :popper-append-to-body="false">
    ...
    <div class="input medium">
        ...
        <div class="input-field">
            <el-date-picker v-model="startDate" type="date" placeholder="시작일" :size="size" />
            <el-date-picker v-model="startDate" type="date" placeholder="종료일" :size="size" />
        </div>
    </div>
